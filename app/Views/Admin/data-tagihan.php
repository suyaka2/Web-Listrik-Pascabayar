...
<div class="modal fade" id="bayarModal" tabindex="-1" aria-labelledby="bayarModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?= base_url('/simpan-pembayaran'); ?>" method="POST">
        <div class="modal-body">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="bayar_nama_pelanggan" readonly>
            </div>
            <div class="mb-3">
              <label class="col-form-label">Periode</label>
              <input type="text" class="form-control" id="bayar_periode" readonly>
            </div>
            <div class="mb-3">
              <label class="col-form-label">Total Tagihan</label>
              <input type="text" class="form-control" id="bayar_total_tagihan" readonly>
              <input type="hidden" id="bayar_total_tagihan_raw"> </div>
            <div class="mb-3">
              <label for="bayar_biaya_admin" class="col-form-label">Biaya Admin</label>
              <input type="number" class="form-control" id="bayar_biaya_admin" name="biaya_admin" value="2500">
            </div>
             <div class="mb-3">
              <label for="bayar_tanggal" class="col-form-label">Tanggal Pembayaran</label>
              <input type="date" class="form-control" id="bayar_tanggal" name="tanggal_pembayaran">
            </div>
            <hr>
            <h5 class="text-left">Total Bayar: <span id="total_bayar_display" class="fw-bold"></span></h5>

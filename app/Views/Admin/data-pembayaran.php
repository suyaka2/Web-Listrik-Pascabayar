   ...
   <!-- Content wrapper -->
    ...
    foreach($data_pembayaran as $data) {
      // --- LAKUKAN PROSES PENERJEMAHAN DI SINI ---
        ...
        $periode_teks = $formatter->format($tanggalObj) . ' ' . $data['tahun_tagihan'];
    ...
    <tr>
        ...
        <td><?= $data['jumlah_meter'];?> kWh</td>
         ...
         <!-- PERBAIKAN TANGGAL PEMBAYARAN -->
        <td>
            <?= date('d F Y', strtotime($data['tanggal_pembayaran'])) ?>
        </td>
        
        <!-- PERBAIKAN TOTAL BAYAR -->
        <td>
